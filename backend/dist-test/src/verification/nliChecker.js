...
exports.NLIConsistencyChecker = void 0;
...
class NLIConsistencyChecker {
    ...
    async checkNLI(premise, hypothesis) {
        try {
            const response = await axios_1.default.post(`${this.modelServiceUrl}/nli-check`, { premise, hypothesis }, { timeout: 5000 });
    ...
    localNLIFallback(premise, hypothesis) {
...
exports.NLIConsistencyChecker = NLIConsistencyChecker;
